...
$temp_analytics = mysqli_query($conn, $sqlAnalytics);
...
$temp_boarders = mysqli_query($conn, $sqlBoarders);
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table class="table" id="incomeTable">
                    ...
                    <tbody>
                      <?php
                      if (mysqli_num_rows($temp_analytics) >= 1) {

                        while ($row = mysqli_fetch_assoc($temp_analytics)) {
                          echo "<tr>";
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table class="table" id="boardersTable">
                    ...
                    <tbody>
                      <?php
                      if (mysqli_num_rows($temp_boarders) >= 1) {
                        while ($row = mysqli_fetch_assoc($temp_boarders)) {
                          echo "<tr>";
                          echo "<td>{$row['rs_id']}</td>";
