...
$sql = "SELECT username FROM accounts WHERE id = :sessionId";
                        ...
                        <?php
                            switch($current_page){
                                case "index.php":
                                    echo("Dashboard");
                                    break;
                                case "my_listings.php":
                                    echo("My Listings");
                                    break;
                                case "reservations.php":
                                    echo("Reservations");
                                    break;
                                case "reviews_ratings.php":
                                    echo("Reviews and Ratings");
                                    break;
                                case "messages.php":
                                    echo("Messages");
                                    break;
                                case "analytics_reports.php":
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <i class="fa fa-user fa-2xl" aria-hidden="true"></i>
                            <div class="header-info">
                                ...
                                <p class="fs-12 mb-0">Boarding House Owner</p>
                            </div>
                        </a>
